...
var ct = function() {
}, it = [{ segment: "autocomplete-core", version: "1.7.4" }], at = { current: {} };
function ut(e2) {
  (function(e3, t2) {
    if (!e3) {
      var n2 = t2.trim();
...
var Yt, Gt, Xt, en = null, tn = (Yt = -1, Gt = -1, Xt = void 0, function(e2) {
  var t2 = ++Yt;
...
var Wr = { Read: 1, Write: 2, Any: 3 }, Kr = 1, zr = 2, Jr = 3;
function $r(e2) {
