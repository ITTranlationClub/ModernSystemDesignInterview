  ...
  [
    /* @__PURE__ */ createBaseVNode("li", null, [
      /* @__PURE__ */ createBaseVNode("p", null, [
        ...
        /* @__PURE__ */ createTextVNode(" 用于存储由服务提供商定义的规则和使用该服务的用户的元数据。")
      ])
    ]),
    /* @__PURE__ */ createBaseVNode("li", null, [
      /* @__PURE__ */ createBaseVNode("p", null, [
        /* @__PURE__ */ createBaseVNode("strong", null, "缓存"),
        /* @__PURE__ */ createTextVNode(" 用于缓存规则和用户数据以进行频繁访问。")
      ])
    ]),
    /* @__PURE__ */ createBaseVNode("li", null, [
      /* @__PURE__ */ createBaseVNode("p", null, [
        /* @__PURE__ */ createBaseVNode("strong", null, "队列"),
        /* @__PURE__ */ createTextVNode(" 对于持有由速率限制器允许的传入请求是必不可少的。")
      ])
    ])
  ],
  -1
